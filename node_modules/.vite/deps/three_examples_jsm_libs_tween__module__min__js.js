...
_Group.prototype = { getAll: function() {
  ...
  for (t = void 0 !== t ? t : TWEEN.now(); 0 < e.length; ) {
    ...
    for (var i = 0; i < e.length; i++) {
      ...
      r && false === r.update(t) && (r._isPlaying = false, n || delete this._tweens[e[i]]);
    }
...
TWEEN.Group = _Group, TWEEN._nextId = 0, TWEEN.nextId = function() {
  ...
  for (var n in this._group.add(this), this._isPlaying = true, this._onStartCallbackFired = false, this._startTime = void 0 !== t ? "string" == typeof t ? TWEEN.now() + parseFloat(t) : t : TWEEN.now(), this._startTime += this._delayTime, this._valuesEnd) {
    ...
    void 0 !== this._object[n] && (this._valuesStart[n] = this._object[n], this._valuesStart[n] instanceof Array == false && (this._valuesStart[n] *= 1), this._valuesStartRepeat[n] = this._valuesStart[n] || 0);
  }
  return this;
}, stop: function() {
  return this._isPlaying && (this._group.remove(this), this._isPlaying = false, null !== this._onStopCallback && this._onStopCallback(this._object), this.stopChainedTweens()), this;
}, end: function() {
  ...
  if (t < this._startTime)
    return true;
  for (n in false === this._onStartCallbackFired && (null !== this._onStartCallback && this._onStartCallback(this._object), this._onStartCallbackFired = true), e = (t - this._startTime) / this._duration, e = 0 === this._duration || 1 < e ? 1 : e, i = this._easingFunction(e), this._valuesEnd)
  ...
  if (0 < this._repeat) {
    ...
    return this._yoyo && (this._reversed = !this._reversed), void 0 !== this._repeatDelayTime ? this._startTime = t + this._repeatDelayTime : this._startTime = t + this._delayTime, true;
  }
...
//# sourceMappingURL=three_examples_jsm_libs_tween__module__min__js.js.map
